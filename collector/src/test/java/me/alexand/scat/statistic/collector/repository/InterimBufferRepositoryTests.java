...
public class InterimBufferRepositoryTests {
    ...
    public void testDeleteBetween() {
        assertEquals(EXPECTED_DELETED_RECORDS_COUNT, repository.delete(DELETE_BEFORE_DATE_TIME));
        assertEquals(0, repository.delete(LocalDateTime.parse("2017-04-01T17:06:10")));
    }
